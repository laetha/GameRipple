...
?>
        ...
        <div class="col-md-10 col-centered">
         <div class="col-sm-6 typebox col-centered" id="name">
             ...
             <div class="text col-centered col-md-12">Review<textarea type="text" name="review" id="review"><?php echo $review; ?></textarea></div>
       </div>
        </div>
